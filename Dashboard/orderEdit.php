...
<div class="container mt-5 mb-5">
        ...
        <?php endif;?>
        <?php if($Order->deliver != "done"):?>
        <form method="post" action="../Controller/OrderController.php" class="border p-3" enctype="multipart/form-data">
                        <input type="hidden" value="update" name="action">
                        <input type="hidden" value="<?php echo $Order->id;  ?>" name="id">
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" name="delivery" id="exampleCheck1" value="checked">
                            <label class="form-check-label" name="delivery" for="exampleCheck1">Check here if order delivered to customer</label>
                        </div>
